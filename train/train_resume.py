...
import pickle
import sys
sys.path.append("D:/vmas_research/HetGPPO")
...
def train(
    ...
    checkpoint_rel_path = "D:/vmas_research/HetGPPO/ray_results/multi_give_way_test/HetGPPO/MultiPPOTrainer_multi_give_way_test_e3a4f_00000_0_2023-12-07_23-54-22/checkpoint_000086/checkpoint_000086"
    #checkpoint_path = PathUtils.scratch_dir / checkpoint_rel_path
    checkpoint_path = sys.path(checkpoint_rel_path)
    #print(PathUtils.scratch_dir)
    ...
    tune.run(
        ...
        callbacks=[
            WandbLoggerCallback(
                ...
                api_key_file=str(PathUtils.scratch_dir / "wandb_api_key"),
                group=group_name,
                notes=notes,
            )
        ],
